...
public class JezykiControllerTests
{
    private readonly Mock<IJezykiService> _mockJezykService;
    private readonly JezykiController _controller;

    public JezykiControllerTests()
    {
        _mockJezykService = new Mock<IJezykiService>();
        _controller = new JezykiController(_mockJezykService.Object);
    }
