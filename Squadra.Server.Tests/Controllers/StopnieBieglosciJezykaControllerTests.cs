...
public class StopnieBieglosciJezykaControllerTests
{
    private readonly Mock<IStopnieBieglosciJezykaService> _mockStopienBieglosciJezykaService;
    private readonly StopnieBieglosciJezykaController _controller;

    public StopnieBieglosciJezykaControllerTests()
    {
        _mockStopienBieglosciJezykaService = new Mock<IStopnieBieglosciJezykaService>();
        _controller = new StopnieBieglosciJezykaController(_mockStopienBieglosciJezykaService.Object);
    }
