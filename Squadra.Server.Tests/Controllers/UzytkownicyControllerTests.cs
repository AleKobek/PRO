...
public class UzytkownicyControllerTests
{
    ...
    private readonly UzytkownicyController _controller;

    public UzytkownicyControllerTests()
    {
        ...
        _controller = new UzytkownicyController(_mockUzytkownikService.Object, _mockUsunKontoService.Object, _mockUserManager.Object);
    }
