...
public class RegionyControllerTests
{
    private readonly Mock<IRegionyService> _mockRegionService;
    private readonly RegionyController _controller;

    public RegionyControllerTests()
    {
        _mockRegionService = new Mock<IRegionyService>();
        _controller = new RegionyController(_mockRegionService.Object);
    }
