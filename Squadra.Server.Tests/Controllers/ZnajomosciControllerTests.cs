...
public class ZnajomosciControllerTests
{
    ...
    private readonly ZnajomosciController _controller;

    public ZnajomosciControllerTests()
    {
        ...
        _controller = new ZnajomosciController(
