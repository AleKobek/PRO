...
public class StatusyControllerTests
{
    private readonly Mock<IStatusyService> _mockStatusService;
    private readonly StatusyController _controller;

    public StatusyControllerTests()
    {
        _mockStatusService = new Mock<IStatusyService>();
        _controller = new StatusyController(_mockStatusService.Object);
    }
