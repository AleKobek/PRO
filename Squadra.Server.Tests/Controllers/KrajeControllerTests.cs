...
public class KrajeControllerTests
{
    private readonly Mock<IKrajeService> _mockKrajService;
    private readonly KrajeController _controller;

    public KrajeControllerTests()
    {
        _mockKrajService = new Mock<IKrajeService>();
        _controller = new KrajeController(_mockKrajService.Object);
    }
