...
public class PowiadomieniaServiceTests
{
    ...
    private readonly Mock<IZnajomosciService> _mockZnajomiService;
    ...
    private readonly PowiadomieniaService _service;

    public PowiadomieniaServiceTests()
    {
        _mockPowiadomienieRepository = new Mock<IPowiadomieniaRepository>();
        _mockUzytkownikService = new Mock<IUzytkownicyService>();
        _mockZnajomiService = new Mock<IZnajomosciService>();
        ...
        _service = new PowiadomieniaService(
    ...
    {
        return Enumerable.Range(1, ZnajomosciService.MaxLiczbaZnajomych)
