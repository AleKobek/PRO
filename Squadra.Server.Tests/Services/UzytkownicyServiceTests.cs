...
{
    private readonly Mock<IUzytkownicyRepository> _mockRepository;
    private readonly Mock<IProfileService> _mockProfilService;
    private readonly UzytkownicyService _service;

    public UzytkownicyServiceTests()
    {
        _mockRepository = new Mock<IUzytkownicyRepository>();
        _mockProfilService = new Mock<IProfileService>();
        _service = new UzytkownicyService(_mockRepository.Object, _mockProfilService.Object);
    }
