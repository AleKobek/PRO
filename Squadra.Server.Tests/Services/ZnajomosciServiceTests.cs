...
public class ZnajomosciServiceTests
{
    private readonly Mock<IZnajomosciRepository> _mockRepository;
    ...
    private readonly ZnajomosciService _service;

    public ZnajomosciServiceTests()
    {
        _mockRepository = new Mock<IZnajomosciRepository>();
        _mockProfilService = new Mock<IProfileService>();
        _mockStatystykiCzatuService = new Mock<IStatystykiCzatuService>();

        _service = new ZnajomosciService(
