...
public class JezykiServiceTests
{
    private readonly Mock<IJezykiRepository> _mockRepository;
    private readonly JezykiService _service;

    public JezykiServiceTests()
    {
        _mockRepository = new Mock<IJezykiRepository>();
        _service = new JezykiService(_mockRepository.Object);
    }
