...
public class ProfileServiceTests
{
    ...
    private readonly Mock<IUzytkownicyRepository> _mockUzytkownikRepository;
    private readonly Mock<IStatusyRepository> _mockStatusRepository;
    private readonly Mock<IJezykiService> _mockJezykService;
    private readonly ProfileService _service;

    public ProfileServiceTests()
    {
        _mockProfilRepository = new Mock<IProfileRepository>();
        _mockUzytkownikRepository = new Mock<IUzytkownicyRepository>();
        _mockJezykService = new Mock<IJezykiService>();
        _mockStatusRepository = new Mock<IStatusyRepository>();
