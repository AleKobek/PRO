...
public class RegionyServiceTests
{
    private readonly Mock<IRegionyRepository> _mockRepository;
    private readonly RegionyService _service;

    public RegionyServiceTests()
    {
        _mockRepository = new Mock<IRegionyRepository>();
        _service = new RegionyService(_mockRepository.Object);
    }
