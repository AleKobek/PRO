...
public class KrajeServiceTests
{
    private readonly Mock<IKrajeRepository> _mockRepository;
    private readonly KrajeService _service;

    public KrajeServiceTests()
    {
        _mockRepository = new Mock<IKrajeRepository>();
        _service = new KrajeService(_mockRepository.Object);
    }
