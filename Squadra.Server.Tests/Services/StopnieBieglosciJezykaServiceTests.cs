...
public class StopnieBieglosciJezykaServiceTests
{
    private readonly Mock<IStopnieBieglosciJezykaRepository> _mockRepository;
    private readonly StopnieBieglosciJezykaService _service;

    public StopnieBieglosciJezykaServiceTests()
    {
        _mockRepository = new Mock<IStopnieBieglosciJezykaRepository>();
        _service = new StopnieBieglosciJezykaService(_mockRepository.Object);
    }
