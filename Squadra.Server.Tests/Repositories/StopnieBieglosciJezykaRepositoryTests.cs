...
public class StopnieBieglosciJezykaRepositoryTests : IDisposable
{
    private readonly AppDbContext _context;
    private readonly StopnieBieglosciJezykaRepository _repository;

    public StopnieBieglosciJezykaRepositoryTests()
    {
        ...
        _repository = new StopnieBieglosciJezykaRepository(_context);
