...
public class JezykiRepositoryTests : IDisposable
{
    private readonly AppDbContext _context;
    private readonly Mock<IStopnieBieglosciJezykaRepository> _mockStopienRepository;
    private readonly JezykiRepository _repository;

    public JezykiRepositoryTests()
    {
        ...
        _mockStopienRepository = new Mock<IStopnieBieglosciJezykaRepository>();
        _repository = new JezykiRepository(_context, _mockStopienRepository.Object);
