...
public class WiadomosciRepositoryTests : IDisposable
{
    private readonly AppDbContext _context;
    private readonly WiadomosciRepository _repository;

    public WiadomosciRepositoryTests()
    {
        ...
        _repository = new WiadomosciRepository(_context);
