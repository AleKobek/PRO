...
public class PowiadomieniaRepositoryTests : IDisposable
{
    private readonly AppDbContext _context;
    private readonly PowiadomieniaRepository _repository;

    public PowiadomieniaRepositoryTests()
    {
        ...
        _repository = new PowiadomieniaRepository(_context);
