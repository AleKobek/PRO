...
public class KrajeRepositoryTests : IDisposable
{
    private readonly AppDbContext _context;
    private readonly KrajeRepository _repository;

    public KrajeRepositoryTests()
    {
        ...
        _repository = new KrajeRepository(_context);
