...
public class ProfileRepositoryTests : IDisposable
{
    ...
    private readonly Mock<IJezykiRepository> _mockJezykRepository;
    private readonly Mock<IRegionyRepository> _mockRegionRepository;
    ...
    public ProfileRepositoryTests()
    {
        ...
        _mockJezykRepository = new Mock<IJezykiRepository>();
        _mockRegionRepository = new Mock<IRegionyRepository>();
