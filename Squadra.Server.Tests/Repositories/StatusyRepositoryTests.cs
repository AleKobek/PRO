...
public class StatusyRepositoryTests : IDisposable
{
    private readonly AppDbContext _context;
    private readonly StatusyRepository _repository;

    public StatusyRepositoryTests()
    {
        ...
        _repository = new StatusyRepository(_context);
