...
public class RegionyRepositoryTests : IDisposable
{
    private readonly AppDbContext _context;
    private readonly Mock<IKrajeRepository> _mockKrajRepository;
    private readonly RegionyRepository _repository;

    public RegionyRepositoryTests()
    {
        ...
        _mockKrajRepository = new Mock<IKrajeRepository>();
        _repository = new RegionyRepository(_context, _mockKrajRepository.Object);
