...
export default function OkienkoTlumaczaceZintegrowanie ({ ustawPokazOkienkoTlumaczenia, ref}) {
    ...
    >
        ...
        <div className="flex flex-col">
            ...
            <p className="mb-4">
                Użytkownik może połączyć swoje konto z kontem na zewnętrznym serwisie, pobierającym statystyki dotyczące gier użytkownika, wybierając tę opcję na stronie "edytuj konto".
