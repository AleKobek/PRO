...
public class KrajeService (IKrajeRepository krajeRepository) : IKrajeService
{
    public async Task<ServiceResult<ICollection<KrajDto>>> GetKraje()
    {
        return ServiceResult<ICollection<KrajDto>>.Ok(await krajeRepository.GetKraje());
    }
    ...
    public async Task<ServiceResult<KrajDto>> GetKraj(int id)
    {
        try
        {
            return id < 1
                ...
                : ServiceResult<KrajDto>.Ok(await krajeRepository.GetKraj(id));
        }
