...
[ApiController]
public class StatusyController(IStatusyService statusyService) : ControllerBase
{
    [HttpGet]
    ...
    {
        var result = await statusyService.GetStatusy();
    ...
    public async Task<ActionResult<StatusDto?>> GetStatus(int id)
    {
        ...
        var result = await statusyService.GetStatus(id);
