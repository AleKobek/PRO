...
[ApiController]
public class StopnieBieglosciJezykaController(IStopnieBieglosciJezykaService stopnieBieglosciJezykaService) : ControllerBase
{
    [HttpGet]
    ...
    {
        var result = await stopnieBieglosciJezykaService.GetStopnieBieglosciJezyka();
    ...
    {
        var result = await stopnieBieglosciJezykaService.GetStopienBieglosciJezyka(id);
