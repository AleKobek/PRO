    ...
    UserManager<Uzytkownik> userManager) : ControllerBase
{
    ...
    public async Task<ActionResult<UzytkownikResDto>> GetUzytkownikById(int id)
    {
        try
        {
            var result = await uzytkownicyService.GetUzytkownik(id);
    ...
    public async Task<ActionResult<UzytkownikResDto>> GetUzytkownik()
    {
        try
        {
            ...
            var result = await uzytkownicyService.GetUzytkownik(uzytkownik.Id);
    ...
    public async Task<IActionResult> UpdateUzytkownik(int id, [FromBody] UzytkownikUpdateDto dto)
    {
        ...
        var result = await uzytkownicyService.UpdateUzytkownik(id, dto);
    ...
    public async Task<IActionResult> UpdateUzytkownik([FromBody] UzytkownikUpdateDto dto)
    {
        ...
        var result = await uzytkownicyService.UpdateUzytkownik(uzytkownik.Id, dto);
        switch (result.StatusCode)
        {
            case 204:
                return NoContent();
    ...
    public async Task<IActionResult> UpdateHaslo(ZmienHasloDto dto)
    {
        ...
        var result = await uzytkownicyService.UpdateHaslo(uzytkownik.Id, dto.StareHaslo, dto.NoweHaslo);
        return result.StatusCode switch
        {
            204 => NoContent(),
    ...
    {
        var result = await uzytkownicyService.UpdateHaslo(id, stareHaslo, noweHaslo);
        return result.StatusCode switch
        {
            204 => NoContent(),
            400 => BadRequest(result.Errors),
