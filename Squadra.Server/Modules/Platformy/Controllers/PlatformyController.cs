...
[ApiController]
public class PlatformyController(
    ...
    UserManager<Uzytkownik> userManager) : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<PlatformaDto>>> GetPlatformy()
    {
        ...
        var result = await platformyService.GetPlatformy();
    ...
    public async Task<ActionResult<PlatformaDto>> GetPlatforma(int id)
    {
        ...
        var result = await platformyService.GetPlatforma(id);
    ...
    public async Task<ActionResult<IEnumerable<PlatformaUzytkownikaDTO>>> GetPlatformyUzytkownika(int idUzytkownika)
    {
        ...
        var result = await platformyService.GetPlatformyUzytkownika(idUzytkownika);
        return result.StatusCode switch
        {
            200 => Ok(result.Value),
            400 => BadRequest(result.Errors[0].Message),
