...
namespace Squadra.Server.Modules.Znajomosci.Controllers;

[Authorize]
[Route("api/[controller]")]
[ApiController]
public class ZnajomosciController(IZnajomosciService znajomosciService, 
    ...
    UserManager<Uzytkownik> userManager) : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<ZnajomyDoListyDto>>> GetZnajomiDoListy()
    {
        ...
        var result = await znajomosciService.GetZnajomiDoListyUzytkownika(uzytkownik.Id);
    ...
    public async Task<ActionResult<bool>> CzyJestZnajomosc(int idZnajomego)
    {
        ...
        var result = await znajomosciService.CzyJestZnajomosc(uzytkownik.Id, idZnajomego);
    ...
    public async Task<ActionResult<bool>> DeleteZnajomego(int idUsuwanego)
    {
        ...
        var wynikWyszukiwaniaProfilu = await profileService.GetProfil(uzytkownik.Id);
        ...
        var resultPowiadomienia = await powiadomieniaService.CreatePowiadomienie(new PowiadomienieCreateDto(
            5,
    ...
    public async Task<ActionResult<bool>> ZaktualizujOstatnieOtwarcieCzatu(int idZnajomego)
    {
        ...
        var result = await znajomosciService.ZaktualizujOstatnieOtwarcieCzatu(uzytkownik.Id, idZnajomego);
