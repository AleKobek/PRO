...
[ApiController]
public class PowiadomieniaController(IPowiadomieniaService powiadomieniaService, IRozpatrzPowiadomienieService rozpatrzPowiadomienieService,
    UserManager<Uzytkownik> userManager) : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<PowiadomienieDto>>> GetPowiadomienia()
    {
        ...
        var result = await powiadomieniaService.GetPowiadomieniaUzytkownika(uzytkownik.Id);
    ...
    {
        var result = await powiadomieniaService.CreatePowiadomienie(new PowiadomienieCreateDto(
    ...
    public async Task<ActionResult> WyslijZaproszenieDoZnajomychPoLoginie([FromBody]string loginZapraszanegoUzytkownika)
    {
        ...
        var result = await powiadomieniaService.WyslijZaproszenieDoZnajomychPoLoginie(uzytkownik.Id, loginZapraszanegoUzytkownika);
        return result.StatusCode switch
        {
            204 => NoContent(),
            400 => BadRequest(result.Errors[0].Message),
    ...
    public async Task<ActionResult> WyslijZaproszenieDoZnajomychPoId(int idZapraszanegoUzytkownika)
    {
        ...
        var result = await powiadomieniaService.WyslijZaproszenieDoZnajomychPoId(uzytkownik.Id, idZapraszanegoUzytkownika);
        return result.StatusCode switch
        {
            204 => NoContent(),
            400 => BadRequest(result.Errors[0].Message),
