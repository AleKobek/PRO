...
public class PowiadomieniaService(IPowiadomieniaRepository powiadomieniaRepository,
    ...
    ) : IPowiadomieniaService
{
    ...
    public async Task<ServiceResult<ICollection<PowiadomienieDto>>> GetPowiadomieniaUzytkownika(int idUzytkownika)
    {
        ...
        var powiadomienia = await powiadomieniaRepository.GetPowiadomieniaUzytkownika(idUzytkownika);
    ...
    public async Task<ServiceResult<bool>> CzyUzytkownikMaPowiadomienieDanegoTypuPowiazaneZObiektami(int idUzytkownika, int idTypu, int idPowiazanegoObiektu, int? idDrugiegoPowiazanegoObiektu)
    {
        ...
        try
        {
            return ServiceResult<bool>.Ok(
                await powiadomieniaRepository.CzyUzytkownikMaPowiadomienieDanegoTypuPowiazaneZObiektami(idUzytkownika, (int)TypPowiadomieniaEnum.ZaproszenieDoDruzyny ,idPowiazanegoObiektu, idDrugiegoPowiazanegoObiektu));
        }
    ...
    public async Task<ServiceResult<bool>> CreatePowiadomienie(PowiadomienieCreateDto powiadomienie)
    {
        ...
        if ((TypPowiadomieniaEnum)powiadomienie.IdTypuPowiadomienia is 
            ...
            var wynikZnalezieniaUzytkownika = await uzytkownicyService.GetUzytkownik(idUzytkownika);
        ...
        await powiadomieniaRepository.CreatePowiadomienie(powiadomienie);
    ...
    public async Task<ServiceResult<bool>> DeletePowiadomieniaZwiazaneZUzytkownikiem(int idUzytkownika)
    {
        ...
        var uzytkownik = await uzytkownicyService.GetUzytkownik(idUzytkownika);
    ...
    public async Task<ServiceResult<bool>> UsunPowiadomieniaZwiazaneZDruzyna(int idDruzyny)
    {
        ...
        return ServiceResult<bool>.NoContent(await powiadomieniaRepository.UsunPowiadomieniaZwiazaneZDruzyna(idDruzyny));
    }
    ...
    public async Task<ServiceResult<bool>> DeletePowiadomieniaDanegoTypuPowiazaneZObiektami(int? idUzytkownika, int idTypu, int idPowiazanegoObiektu, int? idDrugiegoPowiazanegoObiektu)
    {
        ...
        return ServiceResult<bool>.NoContent(await powiadomieniaRepository.DeletePowiadomieniaDanegoTypuPowiazaneZObiektami(idUzytkownika, idTypu, idPowiazanegoObiektu, idDrugiegoPowiazanegoObiektu));
    }
    ...
    {
        var powiadomieniaDoUsuniecia = await powiadomieniaRepository.PodajPowiadomieniaUzytkownikaPrzekraczajaceLimit(idUzytkownika);
        ...
        foreach (var powiadomienieDoUsuniecia in powiadomieniaDoUsuniecia)
        {
            ...
            {
                var profilRes = await profileService.GetProfil(idUzytkownika);
                ...
                await powiadomieniaRepository.CreatePowiadomienie(powiadomienieDoZapraszajacego); // nie uruchamiamy jeszcze raz w serwisie, bo to by mogło spowodować pętlę, więc wywołujemy repozytorium bezpośrednio
            }
            ...
            if ((TypPowiadomieniaEnum)powiadomienieDoUsuniecia.TypPowiadomieniaId is TypPowiadomieniaEnum.ZaproszenieDoDruzyny)
            {
                try
                {
                    ...
                    await powiadomieniaRepository.CreatePowiadomienie(powiadomienieDoKapitana);
                }
                catch (NieZnalezionoWBazieException e)
                {
        ...
        await powiadomieniaRepository.UsunPowiadomienia(powiadomieniaDoUsuniecia);
        return true;
    }
    ...
    public async Task<ServiceResult<bool>> WyslijZaproszenieDoZnajomychPoLoginie(int idZapraszajacego, string loginZaproszonego)
    {
        try
        {
            ...
            var zapraszanyUzytkownikRes = await uzytkownicyService.GetUzytkownik(loginZaproszonego);
    ...
    public async Task<ServiceResult<bool>> WyslijZaproszenieDoZnajomychPoId(int idZapraszajacego, int idZapraszanego)
    {
        if(idZapraszanego == idZapraszajacego)
            ...
            var powiadomieniaZaproszonego = await powiadomieniaRepository.GetPowiadomieniaUzytkownika(idZapraszanego);
            ...
            if (await znajomosciRepository.CzyJestZnajomosc(idZapraszanego, idZapraszajacego))
            {
                return ServiceResult<bool>.Conflict(
            ...
            var czyAdminRes = await uzytkownicyService.CzyUzytkownikJestAdminem(idZapraszanego);
            ...
            var znajomiZapraszajacego = await znajomosciService.GetZnajomosciUzytkownika(idZapraszajacego);
            if (!znajomiZapraszajacego.Succeeded)
                return ServiceResult<bool>.BadRequest(znajomiZapraszajacego.Errors[0]);
            if (znajomiZapraszajacego.Value != null && znajomiZapraszajacego.Value.Count >= ZnajomosciService.MaxLiczbaZnajomych)
            {
                return ServiceResult<bool>.Conflict(
            ...
            var znajomiZapraszanego = await znajomosciService.GetZnajomosciUzytkownika(idZapraszanego);
            if (!znajomiZapraszanego.Succeeded)
                return ServiceResult<bool>.BadRequest(znajomiZapraszanego.Errors[0]);
            if (znajomiZapraszanego.Value != null && znajomiZapraszanego.Value.Count >= ZnajomosciService.MaxLiczbaZnajomych)
            {
                return ServiceResult<bool>.Conflict(
            ...
            var wynikSzukaniaPseudonimuZapraszajacego = await profileService.GetProfil(idZapraszajacego);
            ...
            // jest w porządku
            return ServiceResult<bool>.NoContent(await powiadomieniaRepository.CreatePowiadomienie(dto));
    }
    ...
    public async Task<ServiceResult<bool>> WyslijPowiadomienieODolaczeniuDoDruzyny(int idDolaczajacego, int idKapitana, int idDruzyny, string nazwaDruzyny, string? nazwaRoli)
    {
        ...
        var profilDolaczajacegoRes = await profileService.GetProfil(idDolaczajacego);
    ...
    public async Task<ServiceResult<bool>> WyslijZaproszenieNaMiejsceWDruzynie(int idZapraszanego, int idDruzyny, string nazwaDruzyny, int idMiejsca, string? nazwaRoli)
    {
        ...
        await powiadomieniaRepository.DeletePowiadomieniaDanegoTypuPowiazaneZObiektami(null, (int)TypPowiadomieniaEnum.ZaproszenieDoDruzyny, idDruzyny, idMiejsca);
    ...
    public async Task<ServiceResult<bool>> WyslijPowiadomienieOUsunieciuZDruzyny(int idUsuwanego, int idDruzyny, string nazwaDruzyny)
    {
        ...
        var profilUsuwanegoRes = await profileService.GetProfil(idUsuwanego);
    ...
    public async Task<ServiceResult<bool>> WyslijPowiadomienieOWyjsciuZDruzyny(int idKapitana, int? idOpuszczajacego, int idDruzyny, string nazwaDruzyny, string? nazwaRoli, bool czyPrzyUsuwaniuKonta)
    {
        ...
        if(!czyPrzyUsuwaniuKonta){
            ...
            var profilOpuszczajacegoRes = await profileService.GetProfil(idOpuszczajacego ?? 1); // nie będzie sytuacji tutaj, że to będzie null, ale aby się nie czepiał kompilator
