...
{
    public Task<ServiceResult<StatystykaZNazwaKategoriiDTO>> GetStatystyka(int idStatystyki);
    ...
    public Task<ServiceResult<bool>> CzyUzytkownikSpelniaOgolneWymaganiaDruzyny(int idDruzyny, int idUzytkownika);
    public Task<ServiceResult<bool>> CzyUzytkownikSpelniaWymagania(ICollection<WartoscStatystykiDTO> wymagania, int idUzytkownika);
    ...
    public Task<ServiceResult<bool>> UsunWymaganeStatystykiDruzyny(int idDruzyny);
}